/**
 * Simplified Test Script for Multi-Step Application Submission
 * 
 * This script tests the basic functionality of the application submission system,
 * including resume upload and submission to Supabase without using the metadata column.
 */
...
async function testApplicationSubmission(resumeUrl) {
  ...
  try {
    // Prepare application data without metadata
