/**
 * Minimal Test Script for Multi-Step Application Submission
 * 
 * This script tests the basic functionality of the application submission system,
 * using only the columns that exist in the applications table according to the schema.
 */
...
const testCandidateId = 'test-candidate-id'; // This should match a clerk_id in your users table
...
async function testApplicationSubmission(resumeUrl) {
  ...
  try {
    // Prepare application data with only the columns that exist in the table
    // Based on the schema in user_relationships.sql
    const applicationData = {
      job_id: testJobId,
      candidate_id: testCandidateId,
      status: 'pending',
      resume_url: resumeUrl
      // Omitting cover_letter as it seems to be causing issues
      // Omitting created_at and updated_at as they have default values
    };
