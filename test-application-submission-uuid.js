/**
 * UUID Test Script for Multi-Step Application Submission
 * 
 * This script tests the basic functionality of the application submission system,
 * using UUID format for both job_id and candidate_id.
 */
...
// Test data - Use real job ID and UUID format for candidate_id
const testJobId = '00000000-0000-0000-0000-000000000001'; // Real job ID from the database
const testCandidateId = '00000000-0000-0000-0000-000000000002'; // UUID format candidate_id
...
async function testApplicationSubmission(resumeUrl) {
  ...
  try {
    ...
    // Based on the schema check results and using UUID format for candidate_id
