/**
 * Working Test Script for Multi-Step Application Submission
 * 
 * This script tests the basic functionality of the application submission system,
 * using the actual columns that exist in the applications table.
 */
...
async function testApplicationSubmission(resumeUrl) {
  ...
  try {
    ...
    const applicationData = {
      ...
      resume: resumeUrl,  // Using 'resume' instead of 'resume_url'
      status: 'pending'
